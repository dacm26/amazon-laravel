    ...
    <div id="form">
      <div class="logo">
        <div class="container">
          ...
          <div class="subtitle">User Sign Up</div>
        </div>
      </div>
     {{ Form::open(array('route' => array('customers.store'),'class'=>'form', 'method' => 'post')) }}
             <div class="form-item">
                <p class="formLabel">Name</p>
                {{ Form::text('name',"",array('class' => 'form-style','id'=>'name','name'=>'name','onkeypress'=>'return soloLetras(event)')) }}
                {{ $errors->first('name') }}
             </div>
             <div class="form-item">
                <p class="formLabel">Email</p>
                {{ Form::email('email',"",array('class' => 'form-style','id'=>'email','email'=>'email','placeholder'=>'')) }}
                {{ $errors->first('email') }}
             </div>      


          <div class="form-group">
            {{ Form::input('date', 'birthday', null, ['class' => 'form-style', 'placeholder' => 'Date']) }}
            {{ $errors->first('birthday') }}
          </div>
          <!-- date  -->
             <div class="form-item">
                <p class="formLabel">Mobile</p>
                {{ Form::text('mobile',"",array('class' => 'form-style','id'=>'mobile','mobile'=>'mobile','onkeypress'=>'return soloNumeros(event)')) }}
                {{ $errors->first('mobile') }}
             </div>      

             <div class="form-item">
                <p class="formLabel">Shipping Address</p>
                {{ Form::text('address',"",array('class' => 'form-style','id'=>'address','address'=>'address')) }}
          ...
          <!-- textarea  -->
              ...
              <div class="form-item">
                ...
                {{ Form::text('postal_code',"",array('class' => 'form-style','id'=>'postal_code','postal_code'=>'postal_code','onkeypress'=>'return soloNumeros(event)', 'placeholder'=>'10111')) }}
                {{ $errors->first('postal_code') }}
             </div>           

          
          <div class="form-group">
            {{ Form::radio('gender','M') }} <strong>Male</strong><br>
            {{ Form::radio('gender', 'F', true) }}<strong> Female</strong>
          </div>
             <div class="form-item">
                <p class="formLabel">Password</p>
                {{ Form::password('password',array('class' => 'form-style','id'=>'password','password'=>'password')) }}
                {{ $errors->first('password') }}
             </div>

      
     <div class="form-item">
       <p class="pull-left"><a href="{{ URL::to('signin') }}"><small>Back</small></a></p>
       {{ Form::submit('Sign Up',['class' => 'login pull-right']) }}
